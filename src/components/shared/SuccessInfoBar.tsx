...
const SuccessInfoBar: React.FC<Info> = (props) => {
    ...
    return (
        <div id="alert-3" className="absolute top-[58px] left-0 right-0 flex p-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
